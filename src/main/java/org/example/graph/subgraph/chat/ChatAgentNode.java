...
public class ChatAgentNode implements NodeAction {
    ...
    public ChatAgentNode(String dashScopeApiKey, ToolCallbackProvider tools) {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        logger.info("ChatAgentNode: 处理通用对话, input={}", input.substring(0, Math.min(50, input.length())));
